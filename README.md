...
* [**2. Choosing Your Newsletter Style**](#2-choosing-your-newsletter-style)
* [**3. Choosing Your Platform**](#3-choosing-your-platform)
    * [Beehiiv](#beehiiv)
    * [Substack](#substack)
    * [Kit (formerly ConvertKit)](#kit-formerly-convertkit)
...
<h3 id="beehiiv">🐝 <a href="https://www.beehiiv.com?via=Ken-Jee">Beehiiv</a></h3>
...
> **💡 Opinion:** In my opinion, Beehiiv is a platform that is the best for paid growth. This is a good balance for those trying to build a brand as well as those who are trying to grow their business.

<h3 id="substack">🧡 <a href="https://substack.com/">Substack</a></h3>
...
<h3 id="discovery-platforms-medium--linkedin">Other Platforms to Consider (Medium & LinkedIn)</h3>

While Beehiiv, Substack, and Kit are excellent for *managing* an audience you already have, they can be "walled gardens"—it is hard for strangers to find your work there.
...
| Analytics and segmentation | ✅ | ✅ | ⚠️ | ⚠️ | ✅ | ✅ | ⚠️ | ✅ |
| Automation (drips) | ⚠️ | ✅ | ❌ | ⚠️ | ⚠️ | ⚠️ | ⚠️ | ✅ |
| Design and template options | ⚠️ | ⚠️ | ⚠️ | ✅ | ⚠️ | ⚠️ | ⚠️ | ✅ |
| Integrations and API | ⚠️ | ✅ | ⚠️ | ⚠️ | ✅ | ✅ | ✅ | ✅ |
| Custom domain support | ✅ | ✅ | ❌ | ❌ | ✅ | ✅ | ⚠️ | ✅ |
| 0% platform fee on monetization | ❌ | ✅ | ❌ | ❌ | ✅ | ✅ | ❌ | ❌ |
| Own subscriber data | ✅ | ✅ | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ |

**Additional Resources:**
* [Beehiiv vs Kit - Email Tool Tester](https://www.emailtooltester.com/en/blog/beehiiv-vs-kit/)
* [Beehiiv vs Kit - Expression Bytes](https://expressionbytes.com/beehiiv-vs-convertkit/)
* [Beehiiv Review after 12 months](https://selfmademillennials.com/beehiiv-review/)
* [Beehiiv vs Substack - Email Tool Tester](https://www.emailtooltester.com/en/blog/beehiiv-vs-substack/)

---

<h2 id="4-writing-your-newsletter">4. Writing Your Newsletter</h2>
...
* **Resource:** [How to Establish Your Brand Voice (Guidelines & Examples)](https://www.moo.com/blog/success-stories/how-to-write-your-tone-of-voice-guidelines)
...
* **Resource:** [How to Write a Unique Value Proposition](https://cxl.com/blog/value-proposition-examples-how-to-create/)
...
* **Resource:** [7 Ways to Use Storytelling in Email Marketing](https://www.mailjet.com/blog/email-best-practices/email-marketing-storytelling/)
...
<h3 id="1-the-technical-setup-dkim-spf-dmarc">1. The Technical Setup (DKIM, SPF, DMARC)</h3>
...
**✅ Action Item:** If you buy a custom domain, log into your DNS provider (GoDaddy, Namecheap) and add the CNAME/TXT records provided by Beehiiv or Kit immediately.

<h3 id="2-the-warm-up-phase">2. The "Warm Up" Phase</h3>
...
<h3 id="3-escaping-the-promotions-tab">3. Escaping the "Promotions" Tab</h3>
...
> **💡 Pro Tip:** If you use Beehiiv or Kit, try to keep your "Text-to-Image" ratio high. If your email is just one giant image poster, it will likely be flagged as spam.

<h3 id="4-list-hygiene-the-hardest-pill-to-swallow">4. List Hygiene (The Hardest Pill to Swallow)</h3>
...
**✅ Action Item:** Every 3–6 months, scrub your list. Create a segment of "Cold Subscribers" (haven't opened in 90 days) and send a re-engagement campaign. If they don't open that, **delete them**. A smaller, engaged list is infinitely more valuable than a large, dead one.

<h3 id="%EF%B8%8F-tools-for-warming-up-your-email">🛠️ Tools for "Warming Up" Your Email</h3>
...
* **[Smartlead](https://www.smartlead.ai/):** Currently the most popular for advanced users. It allows you to warm up unlimited email accounts for a flat fee.
* **[Warmup Inbox](https://www.warmupinbox.com/):** A simple, user-friendly option that gives you a clear "Health Score" for your domain.
* **[Mailreach](https://www.mailreach.co/):** Known for having a very high-quality network of inboxes (fewer bots, more real humans), which provides a better signal to Google.

**📚 Deep Dive Resources on Deliverability:**
* [The 2025 Marketer's Guide to Email Deliverability (Litmus)](https://www.litmus.com/blog/why-email-deliverability-matters)
* [What are DMARC, DKIM, and SPF? (Cloudflare)](https://www.cloudflare.com/learning/email-security/dmarc-dkim-spf/)
* [How to Avoid the Gmail Promotions Tab (MailerCheck)](https://www.mailercheck.com/articles/how-to-avoid-gmail-promotions-tab)
* [Email List Hygiene Best Practices 2025 (MailMonitor)](https://www.mailmonitor.com/email-list-hygiene-best-practices/)
